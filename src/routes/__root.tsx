...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VisionAdapt Engine — Adaptive Accessibility for the Web" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "VisionAdapt Engine — Adaptive Accessibility for the Web" },
      {
      ...
      { name: "twitter:title", content: "VisionAdapt Engine — Adaptive Accessibility for the Web" },
      { name: "description", content: "Reform Labs-A11ai transforms websites for color blindness and visual readability." },
      { property: "og:description", content: "Reform Labs-A11ai transforms websites for color blindness and visual readability." },
      { name: "twitter:description", content: "Reform Labs-A11ai transforms websites for color blindness and visual readability." },
